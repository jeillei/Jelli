...
# def matrix_comb(mat1, mat2):

#     shape1 = mat1.shape
#     shape2 = mat2.shape

#     result_shape = (max(shape1[0], shape2[0]), max(shape1[1],shape2[1]))
#     result = np.zeros(result_shape)

#     mask1 = np.zeros(result_shape, dtype=bool)
#     mask2 = np.zeros(result_shape, dtype=bool)

#     result[:shape1[0], :shape1[1]] += mat1
#     mask1[:shape1[0],:shape1[1]] = True

#     result[:shape2[0],:shape2[1]] += mat2
#     mask2[:shape2[0], :shape2[1]] = True

#     count = mask1.astype(int) + mask2.astype(int)
...
W1, b1, W2, b2, W3, b3= descent(X_train, Y_train, 0.0005, 500)
